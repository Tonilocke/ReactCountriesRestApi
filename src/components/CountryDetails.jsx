            ...
            <div className="container">
                ...
                <div>
                    ...
                    <section className="infos">
                        ...
                        <p><span className="str">Currencies:</span> {country.currencies.length > 1? country.currencies.map(currency => <span className="currencies">{ currency.name } </span>):<span className="currencies">{ country.currencies[0].name } </span> }</p>
                        <p><span className="str">Languages:</span> {country.languages.length > 1?country.languages.map(language => <span className="languages">{ language.name } </span>):<span className="languages">{ country.languages[0].name } </span> }</p>
                    </section>
                    ...
                    <section className="border-countries">
                        <p><span className="str">Border countries:</span>{country.borders.length >1? country.borders.map(border => <span> { border }</span>): <span> {country.borders[0]} </span>} </p>
                    </section>: null
                    }
                </div>
